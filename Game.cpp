...
void Game::Draw(float deltaTime, float totalTime)
{
	...
	hullShader->SetFloat("tessellationAmount", tessellationAmount1);
	...
	ImGui_ImplDX11_NewFrame();
	{
		...
		ImGui::SliderFloat("Tessellation Amount", &tessellationAmount1, 0.0f, 50.0f);
